...
class HiveService:
    ...
    def aggregate_movies_count_by_year(self) -> List[Dict[str, Any]]:
        """按年份统计电影总数"""
        return self.model.get_movies_by_year(None)  # None 表示全量统计

    def aggregate_movies_count_by_genre(self) -> List[Dict[str, Any]]:
        """按类型统计电影数量"""
        return self.model.get_movies_by_genre(None)
