...
class Neo4jService:
    ...
    def get_movies_by_multi_condition(
        ...
        """调用 Neo4jModel 的多条件查询（year/director/starring/actor/title）"""
    ...
    def get_movies_by_actor_name_starring(self, actor_name: str) -> QueryResult:
        ...
        return self.model.get_movies_by_actor_name_starring(actor_name)

    def get_movies_by_actor_name_participated(self, actor_name: str) -> QueryResult:
        """查询指定演员参演的电影（按 actor_name）"""
        return self.model.get_movies_by_actor_name_participated(actor_name)
    ...
    def aggregate_movies_count_by_genre(self, genre: str = "") -> QueryResult:
        """按类型统计电影数量"""
        return self.model.get_movies_by_genre(genre)
